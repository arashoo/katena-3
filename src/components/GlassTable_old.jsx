...
function GlassTable({ glasses, onUpdateGlass, onDeleteGlass, onMoveToBacklog, onSort, sortConfig, onReserveGlass, onUpdateReservation }) {
  ...
  // Since glasses are now pre-grouped from backend, no need for frontend grouping
      ...
      <table className="glass-table">
        <thead>
          <tr>
            ...
            <th onClick={() => onSort('rack')} className="sortable">
              Rack Number {getSortIcon('rack')}
            </th>
                      ...
                      <>
                        ...
                        <td>
                          <span className="rack-numbers">
                            {Array.from(group.rackNumbers).join(', ') || mainGlass.rack}
                          </span>
                        </td>
                        <td>{mainGlass.dateAdded}</td>
                        <td>
