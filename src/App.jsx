...
import DeficiencyFormContent from './components/DeficiencyFormContent'
import DeficiencyViewModal from './components/DeficiencyViewModal'
import DeficiencyEditModal from './components/DeficiencyEditModal'
    ...
    <div className="app">
      ...
      {showDeficiencyView && selectedDeficiency && (
        <DeficiencyViewModal 
          ...
          onClose={() => setShowDeficiencyView(false)}
        />
      )}
